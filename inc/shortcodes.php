...
function parse_shortcode_args( $attributes ) {
    ...
    return array(
        ...
        'post_parent__in'       => $shortcode_attributes['post_parent__in'],
        'post_parent_not__in'   => $shortcode_attributes['post_parent_not__in'],
        'post__in'              => $shortcode_attributes['post__in'],
        'post__not_in'          => $shortcode_attributes['post__not_in'],
